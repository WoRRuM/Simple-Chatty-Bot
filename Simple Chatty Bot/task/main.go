...
func startQuiz() {
	...
	firstAnswer := "1. To repeat a statement multiple times."
	secondAnswer := "2. To decompose a program into several small subroutines."
	thirdAnswer := "3. To determine the execution time of a program."
	fourthAnswer := "4. To interrupt the execution of a program."
	...
	fmt.Println(fourthAnswer)
	for numberOfAttempts = 1; numberOfAttempts <= 3; numberOfAttempts++ {
		fmt.Scan(&intAnswer)
		if intAnswer == 2 {
